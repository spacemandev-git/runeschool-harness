...
export const KEY_BINDINGS: readonly KeyBindingHelp[] = [
  ...
  { keys: '↑ / ↓', action: 'select an agent or backend world' },
  { keys: 'Enter', action: 'open agent / connect or spawn world / submit footer' },
  ...
  { keys: 'r', action: 'refresh backend worlds on World' },
...
export const HELP_TEXT = [
  ...
  '/world sandbox <json>',
  '/record start [resolution] [cameras]',
  '/record stop [camera]',
  '/record status',
  '/stop',
  '/quit',
